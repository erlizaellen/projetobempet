...
export default function PageUsuario(){
    ...
    <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-white border border-orange-500 text-orange-500 px-4 py-1 rounded hover:bg-orange-50">
            + Adicionar Pet
        </button>
    </div>
    <div className="bg-white rounded-lg p-4 flex flex-col gap-4 w-full ">
        <div className="flex items-center justify-between">
            <div className="flex flex-col gap-4">
                <div className="rounded-full bg-orange-200 mr-4 flex items-center justify-center text-xl">
                </div>
            ...
            <div className="flex gap-2">
                <button className="bg-white border border-orange-400 text-orange-400 p-1 rounded hover:bg-orange-50">Editar</button>
                <button className="bg-white border border-red-400 text-red-400 p-1 rounded hover:bg-red-50">Excluir</button>
            </div>
        </div>
