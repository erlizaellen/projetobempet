...
export default function vantagens() {
    return (
        <PageWrapper>
            <div className="w-full p-8 text-center rp-amber-500  max-h-dvh">
            ...
            <div className="w-full h-auto flex flex-wrap ">
                <div className="w-full h-full flex flex-wrap rb:bg-red-600">
                ...
                <div className="w-full h-[50px] flex items-center justify-center  mt-8">
                    ...
                    <button
                        type="submit"
                        className="flex-row  flex items-center justify-center w-[15%] h-[50px] 
